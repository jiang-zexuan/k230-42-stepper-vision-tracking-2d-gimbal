...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : TFT_LCD_CS_Pin */
  GPIO_InitStruct.Pin = TFT_LCD_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(TFT_LCD_CS_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : HIT_INDICATOR_Pin */
  GPIO_InitStruct.Pin = HIT_INDICATOR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
  HAL_GPIO_Init(HIT_INDICATOR_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : TFT_LCD_BL_Pin MOTOR_DIR_Pin */
  GPIO_InitStruct.Pin = TFT_LCD_BL_Pin|MOTOR_DIR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : PITCH_EN_Pin PITCH_DIR_Pin */
  GPIO_InitStruct.Pin = PITCH_EN_Pin|PITCH_DIR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
